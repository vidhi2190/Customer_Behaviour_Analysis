...
ROUND(AVG(purchase_amount_usd),2) AS Puchase_Amounts
FROM Customer_data
...
-- Step 1: Add the new age_group column to your existing table
ALTER TABLE customer_data 
ADD COLUMN age_group VARCHAR(50);

-- Step 2: Temporarily disable safe updates so MySQL allows the bulk update
...
-- Step 4: Re-enable safe updates for safety
